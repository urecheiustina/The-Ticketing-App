...
ostream& operator<<(ostream& out, Locatie l)
{
	...
	out << "Nr total de locuri:" << l.nrTotalLocuri << endl;
	return out;
}
...
public:
	...
	DateEveniment& operator+(float x)
	{
		this->pretBilet += x;
		return *this;
	}
...
void meniu()
{
	...
	cout << "3.Editeaza locatia" << endl;
	cout << "4.Cumpara bilet" << endl;
	cout << "5.Vizualizare bilet" << endl;
	cout << "6. Verificare existenta bilet" << endl;
	cout << "7.Detalii eveniment" << endl;
	cout << "8. Exit" << endl;
}
...
int main()
{
	...
	do {
		...
		case 2:
			system("cls");//pentru a curata ecranul *clear screen*
			cout << loc1 << endl;
			break;

		case 3:
			cout << "Editam locatia: " << loc1.getZone() << endl;
			cout << "Numarul maxim de locuri anterior: " << loc1.getNrTotalLocuri() << endl;
			loc1--;
			cout << "Numarul maxim de locuri a devenit: " << loc1.getNrTotalLocuri() << " pentru locatia: " << loc1.getZone() << endl;
			break;
		...
		case 7:
			...
			bool alegere2;
			cout << "Doriti sa modificati pretul biletelor pentru acest eveniment? " << endl;
			cout << "Pentru a nu schimba pretul apasati cifra 1: " << endl;
			cout << "Pentru a schimba pretul apasati cifra 2:" << endl;
			cin >> alegere2;
			if (alegere2 == 1)
				break;
			else if (alegere2 == 2)
			{
				int alegere3;
				cout << "1. Adauga 8 lei la pretul curent al biletului:" << endl;
				cout << "2. Tripleaza pretul curent al biletului:" << endl;
				cout << "Introduceti alegerea: " << endl;
				cin >> alegere3;
				if (alegere3 == 1) {
					Eveniment1.operator+(8);
					cout << "Pretul biletului a fost modificat, adaugandu-se 8 lei" << endl;

				}
				else if (alegere3 == 2) {
					Eveniment1.operator*(3);
					cout << "Pretul biletului a fost triplat" << endl;

				}
				cout << endl << Eveniment1 << endl;
			}
